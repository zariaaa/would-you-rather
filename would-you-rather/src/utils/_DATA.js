let users = {
    sarahedo: {
      ...
      answers: {
        "8xf0y6ziyjabvozdd253nd": 'QuestionOne',
        "6ni6ok3ym7mf1p33lnez": 'QuestionOne',
        "am8ehyc8byjqgar0jgpub9": 'QuestionTwo',
        "loxhs1bqm25b708cmbf3g": 'QuestionTwo'
      },
    ...
    tylermcginnis: {
      ...
      answers: {
        "vthrdm985a262al8qx3do": 'QuestionOne',
        "xj352vofupe1dqz9emx13r": 'QuestionTwo',
      },
  ...
  export function formatQuestion ({ QuestionOneText, QuestionTwoText, author }) {
    return {
      id: generateUID(),
      timestamp: Date.now(),
      author,
